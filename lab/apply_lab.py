...
public class MainActivity extends Activity {
 ...
 @Override public void onRequestPermissionsResult(int r,String[] p,int[] g){super.onRequestPermissionsResult(r,p,g);if(r==REQ_MIC){if(g.length>0&&g[0]==PackageManager.PERMISSION_GRANTED)webView.evaluateJavascript("window.onAndroidPermissionGranted&&window.onAndroidPermissionGranted()",null);else err(101,"Necesito permiso de micrófono para escucharte.");}}
